...

                    {
                        <div className={` fixed p-2 z-50 top-20 right-5 w-56 bg-white border rounded-xl border-dark-blue ${userOpen ? "block" : "hidden"}`}>
                            <div className='absolute -top-3 right-4'>
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" className="triangle-svg">
                                    <path d="M3 12 L8 5 L13 12 Z" fill="white" stroke="none" />
                                    <path d="M3 12 L8 5" stroke="black" strokeWidth="1" />
                                    <path d="M8 5 L13 12" stroke="black" strokeWidth="1" />
                                </svg>
                            </div>
