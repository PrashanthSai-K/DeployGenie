...
import { adminGetRequest, adminPostRequest, ErrorNotify, SuccessNotify } from '../others/extras';
...
function AdminViewContainer() {
    ...
    const fetchContData = async () => {
        try {
            const response = await adminGetRequest(`/v1/api/container/byname/${cont_name.name}`);
    ...
    const fetchPortData = async () => {
        try {
            const response = await adminGetRequest(`/v1/api/port/bycontainer/${cont_name.name}`)
                                                        ...
                                                        {dropdownVisible === containerData.Id && (
                                                            <div ref={dropdownRef} className="absolute -top-5 right-20  w-32 dropdown-content visible z-40 bg-white dark:bg-gray-800 shadow-md rounded-lg">
                                                                <ul className="py-1 px-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="apple-imac-27-dropdown-button">
                                                                    ...
                                                                    {!isLoading &&
                                                                        <li>
                                                                            <a href={`/admin/container/view/${containerData.ContainerName}`} className="block py-1 px-4 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">View</a>
                                                                        </li>
                                                                    }
                                                                    {
                                                                    ...
                                                                    {
                                                                        !isLoading && containerData.Status === "pending" &&
                                                                        <li
                                                                            className="block py-1 px-4 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                                                            onClick={() => {
                                                                                setCallbackFunction(() => ApproveRequest);
                                                                                setApprovePopupVisible(true);
                                                                                setPopupData(containerData);
                                                                                setStage("approve request");
                                                                                setDropdownVisible(null);
                                                                            }}
                                                                        >
                                                                            Approve
                                                                    ...
                                                                    }
                                                                    {
                                                                        ...
                                                                        <li
                                                                            className="block py-1 px-4 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                                                                            onClick={() => {
                                                                                setCallbackFunction(() => RejectRequest)
                                                                                setApprovePopupVisible(true);
                                                                                setPopupData(containerData);
                                                                                setStage("reject request");
                                                                                setDropdownVisible(null);
                                                                            }}
                                                                        >
                                                                            Reject
